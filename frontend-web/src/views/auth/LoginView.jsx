  ...
  return (
    ...
    <div className="w-full min-h-screen overflow-x-hidden bg-sky-100 flex items-center justify-center p-6 select-none">
      ...
      >
        ...
        {/* ========================================================= */}
        <div 
          className={`w-1/2 h-full bg-white flex flex-col items-center justify-center px-16 transition-all duration-500 ease-in-out z-10 ${
        ...
        {/* ========================================================= */}
        <div 
          className={`absolute top-0 left-1/2 w-1/2 h-full bg-primary transition-all duration-500 ease-in-out z-20 overflow-hidden flex flex-col items-center justify-end pb-48 px-16 text-center text-white ${
            isSignUp ? '-translate-x-full rounded-l-[32px] rounded-r-0' : 'translate-x-0 rounded-r-[32px] rounded-l-0'
          }`}
          style={{ backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden' }}
        >
          {/* Tu imagen de portada de fondo */}
          <img 
            src={portadaLogin} 
            alt="Portada Login" 
